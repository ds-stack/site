...
import {
    ...
    useI18nStep,
    useI18nWarningStep,
} from '@elastic/eui/es/components/steps/step_strings';
import { EuiStepNumber } from "@elastic/eui/es/components/steps/step_number";
...
export var EuiStepHorizontal = function EuiStepHorizontal(_ref) {
    var className = _ref.className,
        ...
        rest = _objectWithoutProperties(_ref, ["className", "step", "title", "isSelected", "isComplete", "onClick", "disabled", "status", "render"]);
    ...
    if (render) {
        return React.createElement(render, {},
            React.createElement("span", {className: "euiStepHorizontal__title"}, title)
        );
    }
    ...
    return /*#__PURE__*/React.createElement("button", _extends({
        ...
        onClick: onStepClick,
        disabled: disabled
    }, rest), /*#__PURE__*/React.createElement(EuiStepNumber, {
